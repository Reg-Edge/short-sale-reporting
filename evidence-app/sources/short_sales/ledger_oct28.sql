-- Historical ledger — October 28, 2025
...
FROM read_parquet('${data_dir}ledger_2025_10_28.parquet')

UNION ALL

SELECT NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
WHERE NOT EXISTS (SELECT 1 FROM read_parquet('${data_dir}ledger_2025_10_28.parquet') LIMIT 1)

-- Historical ledger — October 29, 2025
...
FROM read_parquet('${data_dir}ledger_2025_10_29.parquet')

UNION ALL

SELECT NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
WHERE NOT EXISTS (SELECT 1 FROM read_parquet('${data_dir}ledger_2025_10_29.parquet') LIMIT 1)
